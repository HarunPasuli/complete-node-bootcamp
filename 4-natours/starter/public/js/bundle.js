  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourID) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe("pk_test_BUkd0ZXAj6m0q0jMyRgBxNns00PPtgvjjr"); // 1. Get checkout session from API
          _context.next = 4;
...
var signupForm = document.querySelector(".form--signup"); // Add signup form
...
if (bookBtn) {
  bookBtn.addEventListener("click", function (e) {
    ...
    var tourId = e.target.dataset.tourId; // Corrected line
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "7236" + '/');
